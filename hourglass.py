...
### below is set up for communicating with Philips Hue lights and some quick tests
b = Bridge('172.28.219.179')

# If the app is not registered and the button is not pressed, press the button and call connect() (this only needs to be run a single time)
b.connect()
b.get_api()

# create dictionary of hue and saturation values
